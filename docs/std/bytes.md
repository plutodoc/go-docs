...
This package implements functions for the manipulation of byte slices. It is
...
- [buffer.go](/src/bytes/buffer)
- [bytes.go](/src/bytes/bytes)
- [reader.go](/src/bytes/reader)
